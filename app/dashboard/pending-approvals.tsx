...
export default function PendingApprovals() {
  ...
  const isBusy = isApproving || isRejecting || isApprovingAll
    ...
    <div className="bg-orange-50 dark:bg-orange-950/20 rounded-2xl shadow-sm border border-orange-200 dark:border-orange-800 p-6 lg:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <Button 
          ...
          disabled={isBusy}
          className="bg-green-600 hover:bg-green-700 text-white font-bold shadow-lg shadow-green-200 dark:shadow-none"
        >
          <CheckCircle2 className="w-4 h-4 mr-2" /> Hammasini tasdiqlash
        </Button>
      </div>
